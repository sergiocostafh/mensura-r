---
title: Representando o perfil esquemático de um floresta
author: Sérgio Costa
date: '2019-10-30'
slug: representando-o-perfil-esquematico-de-um-floresta
categories:
  - Fitossociologia
tags:
  - Ecologia
...
perfil <- ggplot(sample)+
  ...
  geom_ellipse(aes(x0=id, y0=h.med, a=1+3*dap01*h.med/15,b=1,angle=0), fill = 'darkgreen')+
  geom_label_repel(aes(x=id,y=h.med+.5,label=especie), direction = 'y', fontface = 'bold',  size = 3, alpha=.8, segment.alpha = 0)+
...
```{r, warning=F}
# Executar função
perfil_esquematico(22)
```
A partir daqui são inúmeras possibilidades de customização. Utilizei uma função genérica para representar o tamanho das copas pois não possuo esses registros na base de dados utilizada nesse exemplo, no entanto a altura e o diâmetro de copa, se coletados, podem ser utilizados para dimensionar os círculos que ilustram as copas das árvores. 
<style>
body {
text-align: justify}
h1 {
