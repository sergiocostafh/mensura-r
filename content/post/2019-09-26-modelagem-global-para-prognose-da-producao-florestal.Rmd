...
subtitle: ''
summary: 'Essa postagem apresenta um procedimento para prognose da produção florestal a nível de povoamento considerando classes de produtividade.'
authors: []
...
Por fim, vamos visualizar a produção esperada na idade de corte por classe de sítio definida.  
```{r, fig.align='center'}
