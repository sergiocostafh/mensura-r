...
$$\frac{d_i}{dbh}=\beta_0\frac{h_i}{h}+\left(\beta_1\frac{h_i}{h}\right)^2+\left(\beta_2\frac{h_i}{h}\right)^3+\left(\beta_3\frac{h_i}{h}\right)^4+\left(\beta_4\frac{h_i}{h}\right)^5$$
