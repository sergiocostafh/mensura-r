...
Obs: Para baixar os dados utilizados nesse exemplo, clique [aqui](https://github.com/sergiocostafh/mensura-r/blob/master/content/post/rarefacao/dados_fitossociologia.xlsx?raw=true).  
