---
title: Representando o perfil esquemático de uma comunidade florestal
author: Sérgio Costa
date: '2019-10-30'
...
```{r}
# Para  fazer download dos dados execute a linha a seguir sem o #
# 
...
```{r, warning=F}
# Executar função
perfil_esquematico(45)
perfil_esquematico(15)
```
