...
summary: ''
authors: []
lastmod: '2019-09-01T20:04:42-03:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
plot(variog4(dados, max.dist = 1000, uvec = 10,messages=FALSE),
     ylab = 'Semivariância', xlab = 'Distância')
```
Verifica-se que as linhas que representam variogramas para diferentes direções se cruzam diversas vezes, sem haver clara distinção de tendências. Deste modo, consideramos verdadeira a premissa de isotropia.
