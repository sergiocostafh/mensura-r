...
tags:
  - ggplot2
subtitle: ''
summary: 'Nesta postagem analiso a série mensal de dados do Sistema de Alerta de Desmatamento do Imazon ao longo de 10 anos.'
authors: []
...
Os picos ocorrem geralmente entre os meses de junho e julho, que coincide com o período do ano de menor pluviosidade na região. No entanto, não há alterações visíveis no padrão de chuvas na região ao longo dos 10 anos de análise, indicando inexistência de períodos mais secos na região, e que portanto, não parece haver relação climática com o aumento na quantidade de focos de incêndio detectados pelo INPE.
